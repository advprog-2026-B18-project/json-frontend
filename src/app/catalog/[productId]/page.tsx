            ...
            <div className="mt-3 flex gap-2 overflow-x-auto pb-1">
              {images.map((img, i) => (
                  <button
                      ...
                      className={`shrink-0 h-16 w-16 overflow-hidden rounded-lg border-2 transition cursor-pointer ${
  ...
  function renderCheckoutArea() {
    ...
    if (!isAuthenticated) {
      return (
          <Link
              ...
              className="block w-full rounded-xl bg-primary py-3 text-center text-sm font-semibold text-white hover:bg-primary-dark transition"
          >
    ...
    if (userRole === 'JASTIPER' && isOwner) {
      return (
          <Link
              ...
              className="block w-full rounded-xl border border-primary py-3 text-center text-sm font-semibold text-primary hover:bg-green-50 transition"
          >
            Edit Produk
          </Link>
      );
    ...
    return (
        <button
            ...
            className="w-full rounded-xl bg-primary py-3 text-sm font-semibold text-white hover:bg-primary-dark transition active:scale-95 cursor-pointer"
        >
          Beli Sekarang
        </button>
    );
    ...
    return (
        <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex flex-col items-center justify-center py-32 text-center px-4">
            ...
            <Link
                href="/catalog"
                className="rounded-xl bg-primary px-6 py-2.5 text-sm font-semibold text-white hover:bg-primary-dark transition"
            >
              Kembali ke Katalog
            </Link>
          </div>
            ...
            <section>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="rounded-xl border border-gray-200 bg-white p-4 text-center">
                  <p className="text-2xl font-bold text-primary-dark">{statsTotalOrders}</p>
                  <p className="text-xs text-gray-500 mt-1">Total Pesanan</p>
                </div>
                <div className="rounded-xl border border-gray-200 bg-white p-4 text-center">
                  <p className="text-2xl font-bold text-primary-dark">{statsTotalReviews}</p>

    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <main className="mx-auto max-w-5xl px-4 py-8 space-y-8">
                ...
                {/* System Wallet / Escrow Summary Section */}
                <div className="rounded-2xl bg-gradient-to-br from-slate-800 to-slate-900 p-6 text-white shadow-sm">
                    <p className="text-sm text-slate-300">Total Dana Escrow Berjalan (Sistem)</p>
                    {dataLoading ? (
                        ...
                        <p className="mt-1 text-sm text-slate-400">Gagal memuat neraca finansial</p>
                    )}
                ...
                {/* Recent Activity: KYC Review Queue */}
                <section>
                    ...
                    {dataLoading ? (
                        ...
                        <EmptyState
                            title="Antrean KYC bersih"
                            description="Tidak ada dokumen atau pengajuan verifikasi akun baru yang perlu ditinjau saat ini."
                            action={{ label: 'Kelola Pengguna', href: '/admin/users' }}
                        />
                    ) : (
                                ...
                                {kycRequests.map((req, idx) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-4 py-3">
                                            <StatusBadge status={req.status} type="kyc" />
                                        </td>

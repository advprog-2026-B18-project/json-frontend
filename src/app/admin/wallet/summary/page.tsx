        ...
        <main className="mx-auto max-w-7xl px-4 py-8">
          ...
          {error && (
              ...
              >
                ...
                <button
                    onClick={fetchSummary}
                    className="ml-4 shrink-0 rounded-lg border border-red-300 px-3 py-1 text-xs font-medium text-red-700 hover:bg-red-100 transition cursor-pointer"
                >
                  Coba lagi
                </button>
              </div>
          ...
          {!loading && !error && (
              <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2">
                <Link
                    ...
                    className="flex items-center justify-between rounded-2xl border border-gray-200 bg-white p-5 shadow-sm hover:border-primary hover:shadow-md transition group"
                >
                  <div>
                  ...
                  <svg
                      className="h-5 w-5 shrink-0 text-gray-400 group-hover:text-primary transition"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                      strokeWidth={2}

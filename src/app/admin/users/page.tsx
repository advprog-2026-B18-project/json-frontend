...
export default function AdminUsersPage() {
  ...
  const selectClass =
      'rounded-lg border border-gray-300 px-3 py-2 text-sm text-gray-700 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-primary bg-white';
            ...
            <div className="mx-auto max-w-6xl">
              ...
              {fetchError && (
                  <div role="alert" className="mb-4 rounded-lg bg-red-50 px-4 py-3 text-sm text-red-600">
                    {fetchError}
                    <button onClick={fetchUsers} className="ml-2 underline cursor-pointer">Coba lagi</button>
                  </div>
              )}

              {/* Action error */}
              {actionError && (
                  <div role="alert" className="mb-4 rounded-lg bg-yellow-50 border border-yellow-200 px-4 py-3 text-sm text-yellow-800">
                    {actionError}
                  </div>
              )}
                                ...
                                <div className="flex items-center justify-end gap-2">
                                  ...
                                  {u.role !== 'ADMIN' && (
                                      <button
                                          ...
                                          className={`rounded-lg px-3 py-1 text-xs font-medium cursor-pointer transition ${
                                              u.status === 'BANNED'
                  ...
                  <div className="mt-5 flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                      <button
                          ...
                          disabled={page <= 1}
                          className="rounded-lg border border-gray-300 px-3 py-1.5 text-sm text-gray-700 hover:bg-gray-50 disabled:opacity-40 disabled:cursor-not-allowed cursor-pointer"
                      >
                        ← Sebelumnya
                      </button>

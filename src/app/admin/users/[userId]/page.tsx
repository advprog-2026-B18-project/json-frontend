...
import { Navbar } from '@/components/Navbar'; // Menggunakan komponen Navbar global cerdas
import {
  adminGetUser,
  isApiError,
...
export default function AdminUserDetailPage() {
  ...
  const fetchWallet = useCallback(async () => {
    ...
    try {
      ...
      // Wallet may not exist yet — fail silently
    } finally {
        ...
        <div className="mx-auto max-w-4xl px-4 py-8">
          <main className="space-y-6">
            ...
            <div>
              ...
              <h1 className="text-2xl font-bold text-gray-900 mt-2">Detail Profil Pengguna</h1>
            </div>
                ...
                <>
                  ...
                  <div className="rounded-2xl bg-white p-6 shadow-sm border border-gray-100">
                    <div className="flex items-start gap-4">
                      <div className="h-16 w-16 shrink-0 rounded-full bg-primary flex items-center justify-center text-white text-xl font-bold shadow-xs">
                  ...
                  <div className="rounded-2xl bg-white p-6 shadow-sm border border-gray-100">
                    ...
                    {userDetail.kyc_status ? (
                        ...
                        <p className="text-sm text-gray-400 italic">Belum ada pengajuan KYC dari pengguna ini.</p>
                    )}
                  </div>
                  ...
                  {userDetail.stats && (
                      <div className="rounded-2xl bg-white p-6 shadow-sm border border-gray-100">
                        <h3 className="text-base font-semibold text-gray-900 mb-4">Statistik Transaksi</h3>
                  ...
                  {/* Wallet Section */}
                  <div className="rounded-2xl bg-white p-6 shadow-sm border border-gray-100">
                    <h3 className="text-base font-semibold text-gray-900 mb-3">Informasi Finansial Dompet</h3>
                    {walletLoading ? (

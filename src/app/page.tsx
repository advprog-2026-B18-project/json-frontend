...
function ProductCard({ product }: { product: ProductResponse }) {
  ...
  return (
      <Link
          ...
          className="group shrink-0 w-48 rounded-xl border border-gray-100 bg-white shadow-sm hover:shadow-md transition overflow-hidden block"
      >
...
function JastiperCard({ jastiper }: { jastiper: ProductJastiper }) {
  ...
  return (
      <Link
          ...
          className="group flex flex-col items-center gap-2 rounded-xl border border-gray-100 bg-white p-4 shadow-sm hover:shadow-md transition text-center w-36 shrink-0 block"
      >
        {profilePictureUrl ? (
            // eslint-disable-next-line @next/next/no-img-element
            <img
...
export default function LandingPage() {
  ...
  return (
      <div className="min-h-screen bg-gray-50">
        ...
        {/* 1. Hero Section                                                    */}
        {/* ------------------------------------------------------------------ */}
        <section className="bg-gradient-to-br from-primary-dark to-primary px-4 py-20 text-center text-white">
